...
angular.module('mean.users')
  .controller('AuthCtrl', ['$scope', '$rootScope', '$http', '$state', 'Global', '$translate',
    function($scope, $rootScope, $http, $state, Global, $translate) {
  ...
  .controller('LoginCtrl', ['$rootScope', 'MeanUser', '$translate',
    function($rootScope, MeanUser, $translate) {
      var vm = this;
